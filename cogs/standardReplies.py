...
class standardRepliesCog(commands.Cog):
    ...
    async def create_standard_reply(self, ctx, category_id: int) -> None:
        try:
            ...
            await conf_msg.edit(embed=common_embed("Standard Reply",
